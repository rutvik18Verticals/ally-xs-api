...
{
    /// <summary>
    /// Represents a column formatter for Facility Tag Alarms Column Formatter values.
    /// </summary>
    public class FacilityTagAlarmsColumnFormatter : ColumnFormatterBase, IColumnFormatter
    {
