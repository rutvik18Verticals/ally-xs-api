    ...
    public class DataHistoryProcessingServiceTests
    {
        ...
        public void GetDataHistoryNullResponseTest()
        {
            ...
            var request = new WithCorrelationId<TrendIDataInput>(correlationId, new TrendIDataInput
            {
                AssetId = new Guid("DFC1D0AD-A824-4965-B78D-AB7755E32DD3"),
                Chart1TrendTypes = "21",
                Chart1TrendNames = "Fluid Load",
                Chart1TrendAddresses = "1234",
                Chart2TrendTypes = "",
                Chart2TrendNames = "",
                Chart2TrendAddresses = "",
                Chart3TrendTypes = "",
                Chart3TrendNames = "",
                Chart3TrendAddresses = "",
                Chart4TrendTypes = "",
                Chart4TrendNames = "",
                Chart4TrendAddresses = "",
        ...
        public void GetDataHistoryCommonTrendProductionStatTrendDataItemsTest()
        {
            ...
            var request = new WithCorrelationId<TrendIDataInput>(correlationId, new TrendIDataInput
            {
                AssetId = new Guid("DFC1D0AD-A824-4965-B78D-AB7755E32DD3"),
                Chart1TrendTypes = "14",
                Chart1TrendNames = "Production Latest BOE",
                Chart1TrendAddresses = "1234",
                Chart2TrendTypes = "",
                Chart2TrendNames = "",
                Chart2TrendAddresses = "",
