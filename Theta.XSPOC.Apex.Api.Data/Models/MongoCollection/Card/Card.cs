...
namespace Theta.XSPOC.Apex.Api.Data.Models.MongoCollection.Card
{
    /// <summary>
    /// Represent card 
    /// </summary>
    public class Card : AssetDocumentBase
    {
        ...
        /// Gets or sets the surface card.
        /// </summary>
        public IList<CoordinatesDataModel<float>> SurfaceCardPoints { get; set; }

        /// <summary>
        /// Gets or sets the downhole card.
        /// </summary>
        public IList<CoordinatesDataModel<float>> DownholeCardPoints { get; set; }

        /// <summary>
        /// Gets or sets the predicted card.
        /// </summary>
        public IList<CoordinatesDataModel<float>> PredictedCardPoints { get; set; }

        /// <summary>
        /// Gets or sets the torque plot minimum energy.
        /// </summary>
        public IList<CoordinatesDataModel<float>> TorquePlotMinEnergyPoints { get; set; }

        /// <summary>
        /// Gets or sets the torque plot minimum torque.
        /// </summary>
        public IList<CoordinatesDataModel<float>> TorquePlotMinTorquePoints { get; set; }

        /// <summary>
        /// Gets or sets the torque plot current.
        /// </summary>
        public IList<CoordinatesDataModel<float>> TorquePlotCurrentPoints { get; set; }

        /// <summary>
        /// Gets or sets the POC downhole card.
        /// </summary>
        public IList<CoordinatesDataModel<float>> POCDownholeCardPoints { get; set; }
        ...
        /// </summary>
        public IList<CoordinatesDataModel<float>> PermissibleLoadUpPoints { get; set; }

        /// <summary>
        /// Gets or sets Permission Load Down.
        /// </summary>
        public IList<CoordinatesDataModel<float>> PermissibleLoadDownPoints { get; set; }

        /// <summary>
        /// Gets or sets Electrogram Card.
        /// </summary>
        public IList<CoordinatesDataModel<float>> ElectrogramCardPoints { get; set; }
    }
}
