...
namespace Theta.XSPOC.Apex.Api.WellControl.Integration.RabbitMq.Publishers
{
    ...
    /// </summary>
    public class StoreUpdatePublisher : ExchangePublisherBase<ProcessDataUpdateContract, Responsibility, Loggers, LoggingModel>
    {

        #region Private Members

        private const string TOPIC_EXCHANGE_NAME = "XSPOC.StoreUpdate.Exchange";
        private const string ROUTING_KEY = "XSPOC.Legacy.StoreUpdate";

        private const string DEAD_LETTER_EXCHANGE_NAME = "XSPOC.StoreUpdate.Exchange.DeadLetter";
        private const string DEAD_LETTER_EXCHANGE_ROUTING_KEY = "#";
        private const string DEAD_LETTER_QUEUE_NAME = "XSPOC.StoreUpdate.DeadLetter.Process";
        ...
        /// <summary>
        /// Creates a new instance of <seealso cref="StoreUpdatePublisher"/>
        /// </summary>
        ...
        /// </exception>
        public StoreUpdatePublisher(IConfiguration config, IConnectionFactory connectionFactory,
        ...
        /// down to the devices.
        /// </summary>
        public override Responsibility Responsibility => Responsibility.PublishStoreUpdateDataToLegacyDBStore;
        ...
        {
            TopicExchangeName = Config.GetSection("TopicExchanges:DataStoreWellUpdatesExchange").Value ??
                                TOPIC_EXCHANGE_NAME;
            BaseRoutingKey = Config.GetSection("TopicExchanges:DataStoreWellUpdatesTransactionRoutingKey").Value ?? ROUTING_KEY;

            DeadLetterExchangeName = Config.GetSection("TopicExchanges:StoreUpdateDeadLetterExchange").Value ??
                DEAD_LETTER_EXCHANGE_NAME;
            DeadLetterExchangeRoutingKey = Config.GetSection("TopicExchanges:StoreUpdateDeadLetterExchangeRoutingKey").Value ??
                DEAD_LETTER_EXCHANGE_ROUTING_KEY;
            DeadLetterQueueName = Config.GetSection("TopicExchanges:StoreUpdateDeadLetterQueue").Value ??
