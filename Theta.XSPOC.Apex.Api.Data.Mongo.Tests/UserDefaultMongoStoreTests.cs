...
{
    [TestClass]
    public class UserDefaultMongoStoreTests
    {
        ...
        {
            _ = new UserDefaultMongoStore(null, null);
        }
        ...
        public void GetItemTest()
        {
            ...
            var dataStore = new UserDefaultMongoStore(mockDatabase.Object, mockThetaLoggerFactory.Object);

            var result = dataStore.GetItem("test", "HasLoggedIn", "Login", "correlationId");
        ...
        public void GetDefaultItemTest()
        {
            ...
            var result = dataStore.GetDefaultItem("test", "Login", "correlationId", "HasLoggedIn");
        ...
        [TestMethod]
        public void GetDefaultItemByGroupTest()
        {
            var logger = new Mock<IThetaLogger>();
            var mockThetaLoggerFactory = new Mock<IThetaLoggerFactory>();
            mockThetaLoggerFactory.Setup(x => x.Create(It.IsAny<LoggingModel>())).Returns(logger.Object);
            ...
            var result = dataStore.GetDefaultItemByGroup("test", "Login", "correlationId");
        ...
        public void SetItemTest()
        {
            ...
            var result = dataStore.SetItem("test", "HasLoggedIn", "Login", "1", "correlationId");
